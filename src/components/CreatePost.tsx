    ...
    <Modal isVisible={isVisible} size="md" onClose={handleClose}>
      <div className="flex justify-between gap-4">
        <div className="flex-1">
          <h3 className="text-2xl text-[#3d3d3d] font-semibold mb-3">Article Preview</h3>
          <img
          ...
          <small className="text-xs text-[#6d6d6d] leading-4">
            <span className="font-bold">Note</span>: Changes here will affect how your article appears in the Article Board — not the contents of the story
            itself.
          </small>
        </div>
        <div className="flex-1">
          <h3 className="text-2xl font-normal">
            Posting to: <span className="font-semibold">{user && user.displayName}</span>
          </h3>
          <p className="text-[#3d3d3d] text-sm my-2">Add or change category (up to 3) so readers know what your story is about</p>
          <Input title="" value="" placeholder="Add category..." onChange={() => {}} />
