...
const Detail = () => {
    ...
    const toggleSeeMore = (stats: boolean = false) => () => {
        setSeeMore(stats)
    }
    const openDrawer = () => {
    ...
    return (
        <div>
            <main className="container mx-auto overlay">
               <Header />
               <Drawer open={open} onClose={toggleDrawer(false)} anchor="right" PaperProps={{width: "90%"}} className="w-100" >
                    <div className="w-[424px] p-5 mt-4">
                        <div className="flex justify-between items-center">
                            <span className="text-[#3D3D3D] font-semibold text-[20px] leading-7">Responses (54)</span>
                            <XCircle size={32} className="cursor-pointer" onClick={toggleDrawer(false)} />
                        </div>
                        ...
                        <div className="w-full shadow-[0_4px_12px_0px_rgba(0,0,0,0.1)] rounded-md p-3 mt-7">
                            ...
                            <TextField autoFocus={false} multiline={true} className="border-none outline-none focus:outline-none w-full"
                        ...
                        <div className="mt-6">
                            ...
                            <div className="mt-4">
                                <p className={"font-normal text-sm overflow-hidden overflow-ellipsis " + (!isSeeMore ? 'line-clamp-5' : '')}>
                                    Lorem ipsum odor amet, consectetuer adipiscing elit. Vulputate facilisi ullamcorper facilisis hac velit sem viverra etiam. Urna ornare facilisi potenti cursus donec ligula. Placerat nisi vestibulum nascetur finibus ac; tellus class. In ultrices conubia amet sem ultrices quam ullamcorper. Adipiscing quisque blandit phasellus blandit mollis tortor volutpat laoreet. Fames pharetra facilisis velit curae odio habitant commodo nam. Feugiat condimentum hac inceptos taciti faucibus tristique.
                                    Fermentum odio faucibus lectus, himenaeos class vulputate lacinia. Cursus penatibus per sollicitudin phasellus neque ad placerat. Elit torquent quam integer auctor ultrices vehicula lobortis duis. Imperdiet lectus luctus mus lacus magnis posuere vitae. Cubilia montes natoque arcu finibus est nec magna. Odio morbi eleifend conubia; egestas varius torquent potenti. Ut lorem ut, aliquet parturient posuere ornare augue dolor. Nullam vel purus maximus vivamus mollis eu nunc ridiculus. Tortor congue blandit lobortis dignissim etiam vulputate turpis nascetur.
                                    Fames diam quis platea arcu rutrum. Turpis suscipit dictumst condimentum dui, lacinia non. Elementum vitae habitant tortor aenean neque integer duis. Ad nisi adipiscing dui per dictumst condimentum. Ut sed efficitur magnis molestie imperdiet curae sodales. Etiam leo sem eleifend eget auctor dictumst justo fringilla. Netus vestibulum platea leo habitant quisque.
                                </p>
                                <button className="font-normal text-sm text-[#FF2E3D]" onClick={toggleSeeMore(true)}>See more</button>
                            </div>
                            <div className="flex flex-rows justify-between items-center mt-2">
                                {/* Comments action */}
                                <div className="flex items-center">
                                    <IconContext.Provider value={{ size: "24px", color: "#F42534" }}>
                                        <span className="flex mr-3 font-normal text-base text-[#6D6D6D] cursor-pointer"><HandsClapping className='mr-2'/> 40</span>
                                        <span onClick={toggleDrawer(true)} className="flex mr-3 font-normal text-base text-[#6D6D6D] cursor-pointer"><ChatsCircle weight="duotone" className='mr-2'/> 5</span>
                            ...
                            <div className="border-[#FFC3C7] border-l-4">
                                {items.map((item, index) => (
                                    <div className="mt-6 px-5">
                                        ...
                                        <div className="mt-4">
                                            <p className={"font-normal text-sm overflow-hidden overflow-ellipsis " + (!isSeeMore ? 'line-clamp-5' : '')}>
                                                Lorem ipsum odor amet, consectetuer adipiscing elit. Vulputate facilisi ullamcorper facilisis hac velit sem viverra etiam.
                                            </p>
                                        </div>
                                        <div className="flex flex-rows justify-between items-center mt-2">
                                            {/* Comments action */}
                ...
                <div className="grow py-8 max-w-4xl mx-auto">
                    ...
                    <div className="gap-8 ">
                        ...
                        <div className="flex flex-rows justify-between items-center mt-12 border-b border-[#E7E7E7] pb-6">
                            ...
                            <div className="flex">
                                <IconContext.Provider value={{ size: "24px", color: "#F42534" }}>
                                    <span className="flex mr-3 font-normal text-[16px] text-[#6D6D6D] cursor-pointer"><HandsClapping className='mr-2'/> 40</span>
                                    <span onClick={toggleDrawer(true)} className="flex mr-3 font-normal text-[16px] text-[#6D6D6D] cursor-pointer"><ChatsCircle weight="duotone" className='mr-2'/> 5</span>
                                    <span className="flex cursor-pointer"><BookmarkSimple /></span>
                                </IconContext.Provider>
                            </div>
                        </div>
                        {/* article banner */}
                        ...
                        <div className="pt-5 mt-5 border-t border-b border-[#E7E7E7] pb-6">
                            ...
                            <div className="flex flex-rows justify-between items-center mt-12">
                                ...
                                <div className="flex">
                                    <IconContext.Provider value={{ size: "24px", color: "#F42534" }}>
                                        <span className="flex mr-3 font-normal text-[16px] text-[#6D6D6D] cursor-pointer"><HandsClapping className='mr-2'/> 40</span>
                                        <span onClick={openDrawer} className="flex mr-3 font-normal text-[16px] text-[#6D6D6D] cursor-pointer"><ChatsCircle weight="duotone" className='mr-2'/> 5</span>
                                        <span className="flex cursor-pointer"><BookmarkSimple /></span>
                                    </IconContext.Provider>
                                </div>
                            </div>
