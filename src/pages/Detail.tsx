            ...
            <div className="mt-6">
              ...
              <div className="mt-4">
                <p className={"font-normal text-sm overflow-hidden overflow-ellipsis " + (!isSeeMore ? "line-clamp-5" : "")}>
                  Lorem ipsum odor amet, consectetuer adipiscing elit. Vulputate facilisi ullamcorper facilisis hac velit sem viverra etiam. Urna ornare
                  facilisi potenti cursus donec ligula. Placerat nisi vestibulum nascetur finibus ac; tellus class. In ultrices conubia amet sem ultrices quam
                  ullamcorper. Adipiscing quisque blandit phasellus blandit mollis tortor volutpat laoreet. Fames pharetra facilisis velit curae odio habitant
                  commodo nam. Feugiat condimentum hac inceptos taciti faucibus tristique. Fermentum odio faucibus lectus, himenaeos class vulputate lacinia.
                  Cursus penatibus per sollicitudin phasellus neque ad placerat. Elit torquent quam integer auctor ultrices vehicula lobortis duis. Imperdiet
                  lectus luctus mus lacus magnis posuere vitae. Cubilia montes natoque arcu finibus est nec magna. Odio morbi eleifend conubia; egestas varius
                  torquent potenti. Ut lorem ut, aliquet parturient posuere ornare augue dolor. Nullam vel purus maximus vivamus mollis eu nunc ridiculus.
                  Tortor congue blandit lobortis dignissim etiam vulputate turpis nascetur. Fames diam quis platea arcu rutrum. Turpis suscipit dictumst
                  condimentum dui, lacinia non. Elementum vitae habitant tortor aenean neque integer duis. Ad nisi adipiscing dui per dictumst condimentum. Ut
                  sed efficitur magnis molestie imperdiet curae sodales. Etiam leo sem eleifend eget auctor dictumst justo fringilla. Netus vestibulum platea
                  leo habitant quisque.
                </p>
                <button className="font-normal text-sm text-[#FF2E3D]" onClick={toggleSeeMore(true)}>
                  See more
                </button>
              </div>
              <div className="flex flex-rows justify-between items-center mt-2">
                ...
                <div className="flex items-center">
                  <IconContext.Provider value={{ size: "24px", color: "#F42534" }}>
                    ...
                    <span onClick={toggleDrawer(true)} className="flex mr-3 font-normal text-base text-[#6D6D6D] cursor-pointer">
